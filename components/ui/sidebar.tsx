  ...
  return (
    ...
    >
      ...
      >
        <div
          data-sidebar="sidebar"
          className="flex h-full w-full flex-col bg-sidebar group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=inset]:border-sidebar-border"
        >
          {children}
        </div>
      </div>
    ...
    return (
      <main
        ...
        className={cn(
          ...
          "peer-data-[collapsible=icon]:md:peer-data-[side=left]:ml-[--sidebar-width-icon] peer-data-[collapsible=icon]:md:peer-data-[side=right]:mr-[--sidebar-width-icon]",
          className
        )}
        {...props}
      />
  ...
  ({ className, ...props }, ref) => {
    return (
      <div
        ...
        className={cn(
          "absolute right-1 flex size-5 items-center justify-center rounded-md px-1.5",
...
>(({ className, showIcon = false, ...props }, ref) => {
  ...
  return (
    ...
    >
      {showIcon && (
        <div className="flex size-4 items-center justify-center rounded-md bg-sidebar-primary/10" />
      )}
      <div
  ...
  ({ className, ...props }, ref) => {
    return (
      <hr
        ...
        className={cn("mx-2 my-2 h-px w-auto border-sidebar-border", className)}
        {...props}
      />
    )
  }
